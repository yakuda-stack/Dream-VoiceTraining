...
| **Linux (AppImage)** | [Download AppImage (v1.1.4)](https://github.com/yakuda-stack/Dream-VoiceTraining/releases/download/v1.1.4/Dream-VoiceTraining-1.1.4-x86_64.AppImage) | Single file execution (`chmod +x` & run) |
| **Windows (Installer)** | [Download Setup `.exe` (v1.1.4)](https://github.com/yakuda-stack/Dream-VoiceTraining/releases/download/v1.1.4/Dream-VoiceTraining-1.1.4.exe) | Standard installer with Start Menu & Desktop shortcuts |
| **Windows (Portable)** | [Download Portable `.exe` (v1.1.4)](https://github.com/yakuda-stack/Dream-VoiceTraining/releases/download/v1.1.4/Dream-VoiceTraining-1.1.4-Portable.exe) | Self-contained, stores data in local folder |
| **All Releases** | [GitHub Releases Overview](https://github.com/yakuda-stack/Dream-VoiceTraining/releases) | Browse older versions & release notes |
