...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "detach_tab": {"en": "Open in own window", "de": "In eigenes Fenster"},
    "reattach_tab": {"en": "Dock back into main window",
                     "de": "Zurück ins Hauptfenster"},
    "detached_title": {"en": "{name} — {app}", "de": "{name} — {app}"},
    ...
    "rename_prompt": {"en": "Display name:", "de": "Anzeigename:"},
